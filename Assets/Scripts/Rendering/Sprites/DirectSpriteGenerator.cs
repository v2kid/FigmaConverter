...
//         {
//             Debug.Log(
//                 $"Sprite not found with instance nodeId {instanceNodeId}, trying with main nodeId {mainNodeId}"
//             );
...
//             // Try to load sprite from Resources first
//             Sprite savedSprite = LoadSpriteFromResourcesWithMainNodeId(
//                 imageRef,
//                 imageRef,
//                 mainNodeId
//             );
...
//             {
//                 Debug.Log(
//                     $"RenderImageFill: Successfully loaded sprite from Resources: {imageRef}"
//                 );
