...
public class SVGSpriteConverter
{
    ...
    public static Sprite ConvertSVGToSprite(
        string svgString,
        float width,
        float height,
    ...
    /// </summary>
    private static void RenderShapeToPixels(
        SVGShape shape,
        Color[] pixels,
        int textureSize,
        float scaleX,
    ...
    /// </summary>
    private static void RenderRectangleToPixels(
        SVGShape shape,
        Color[] pixels,
        int textureSize,
        float scaleX,
    ...
    /// </summary>
    private static void RenderRectangleStroke(
        SVGShape shape,
        Color[] pixels,
        int textureSize,
        float scaleX,
    ...
    /// </summary>
    private static void RenderEllipseToPixels(
        SVGShape shape,
        Color[] pixels,
        int textureSize,
        float scaleX,
    ...
    /// </summary>
    private static void RenderPathToPixels(
        SVGShape shape,
        Color[] pixels,
        int textureSize,
        float scaleX,
