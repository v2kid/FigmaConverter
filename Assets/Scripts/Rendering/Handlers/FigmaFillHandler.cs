...
//             sb.AppendLine($"<defs>");
//             sb.AppendLine(
//                 $"  <linearGradient id=\"{gradientId}\" x1=\"{x1 * 100}%\" y1=\"{y1 * 100}%\" x2=\"{x2 * 100}%\" y2=\"{y2 * 100}%\">"
//             );
...
//                 sb.AppendLine(
//                     $"    <stop offset=\"{position * 100}%\" stop-color=\"{FigmaColorParser.ColorToHex(stopColor)}\" stop-opacity=\"{stopColor.a}\" />"
//                 );
//             }
